...
CREATE TABLE `glpi_plugin_archisw_swcomponents` (
  ...
  `statedate` TIMESTAMP NULL COMMENT 'validity date of swcomponent status',
...
) AUTO_INCREMENT=756 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ;
...
INSERT INTO `glpi_plugin_archisw_configswdbfieldtypes` (`id` ,`name` ,`comment`)  VALUES (40,'TIMESTAMP','Date and time');
